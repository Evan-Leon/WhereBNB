...
#Reviews
review_1 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: ny_listing1.id )
review_2 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: ny_listing1.id )
review_3 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: ny_listing1.id )
review_4 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: ny_listing1.id )
review_5 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: ny_listing2.id )
review_6 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: ny_listing2.id )
review_7 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: ny_listing2.id )
review_8 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: ny_listing2.id )
review_9 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: ny_listing3.id )
review_10 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: ny_listing3.id )
review_11 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: ny_listing3.id )
review_12 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: ny_listing3.id )
review_13 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: ny_listing4.id )
review_14 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: ny_listing4.id )
review_15 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: ny_listing4.id )
review_16 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: ny_listing4.id )
review_17 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: ny_listing5.id )
review_18 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: ny_listing5.id )
review_19 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: ny_listing5.id )
review_20 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: ny_listing5.id )
review_21 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: austin_listing1.id )
review_22 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: austin_listing1.id )
review_23 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: austin_listing1.id )
review_24 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: austin_listing1.id )
review_25 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: austin_listing2.id )
review_26 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: austin_listing2.id )
review_27 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: austin_listing2.id )
review_28 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: austin_listing2.id )
review_29 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: austin_listing3.id )
review_30 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: austin_listing3.id )
review_31 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: austin_listing3.id )
review_32 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: austin_listing3.id )
review_33 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: austin_listing4.id )
review_34 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: austin_listing4.id )
review_35 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: austin_listing4.id )
review_36 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: austin_listing4.id )
review_37 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: austin_listing5.id )
review_38 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: austin_listing5.id )
review_39 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: austin_listing5.id )
review_40 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: austin_listing5.id )
review_41 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: boston_listing1.id )
review_42 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: boston_listing1.id )
review_43 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: boston_listing1.id )
review_44 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: boston_listing1.id )
review_45 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: boston_listing2.id )
review_46 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: boston_listing2.id )
review_47 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: boston_listing2.id )
review_48 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: boston_listing2.id )
review_49 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: boston_listing3.id )
review_50 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: boston_listing3.id )
review_51 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: boston_listing3.id )
review_52 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: boston_listing3.id )
review_53 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: boston_listing4.id )
review_54 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: boston_listing4.id )
review_55 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: boston_listing4.id )
review_56 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: boston_listing4.id )
review_57 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: boston_listing5.id )
review_58 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: boston_listing5.id )
review_59 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: boston_listing5.id )
review_60 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: boston_listing5.id )
review_61 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: chicago_listing1.id )
review_62 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: chicago_listing1.id )
review_63 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: chicago_listing1.id )
review_64 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: chicago_listing1.id )
review_65 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: chicago_listing2.id )
review_66 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: chicago_listing2.id )
review_67 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: chicago_listing2.id )
review_68 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: chicago_listing2.id )
review_69 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: chicago_listing3.id )
review_70 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: chicago_listing3.id )
review_71 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: chicago_listing3.id )
review_72 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: chicago_listing3.id )
review_73 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: chicago_listing4.id )
review_74 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: chicago_listing4.id )
review_75 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: chicago_listing4.id )
review_76 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: chicago_listing4.id )
review_77 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: chicago_listing5.id )
review_78 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: chicago_listing5.id )
review_79 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: chicago_listing5.id )
review_80 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: chicago_listing5.id )
review_81 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: miami_listing1.id )
review_82 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: miami_listing1.id )
review_83 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: miami_listing1.id )
review_84 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: miami_listing1.id )
review_85 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: miami_listing1.id )
review_86 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: miami_listing2.id )
review_87 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: miami_listing2.id )
review_88 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: miami_listing2.id )
review_89 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: miami_listing2.id )
review_90 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: miami_listing2.id )
review_91 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: miami_listing3.id )
review_92 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: miami_listing3.id )
review_93 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: miami_listing3.id )
review_94 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: miami_listing3.id )
review_95 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: miami_listing4.id )
review_96 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: miami_listing4.id )
review_97 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: miami_listing4.id )
review_98 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: miami_listing4.id )
review_99 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: miami_listing5.id )
review_100 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: miami_listing5.id )
review_101 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: miami_listing5.id )
review_102 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: miami_listing5.id )
review_103 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: seattle_listing1.id )
review_104 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: seattle_listing1.id )
review_105 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: seattle_listing1.id )
review_106 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: seattle_listing1.id )
review_107 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: seattle_listing2.id )
review_108 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: seattle_listing2.id )
review_109 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: seattle_listing2.id )
review_110 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: seattle_listing2.id )
review_111 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: seattle_listing3.id )
review_112 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: seattle_listing3.id )
review_113 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: seattle_listing3.id )
review_114 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: seattle_listing3.id )
review_115 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: seattle_listing4.id )
review_116 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: seattle_listing4.id )
review_117 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: seattle_listing4.id )
review_118 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: seattle_listing4.id )
review_119 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: seattle_listing5.id )
review_120 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: seattle_listing5.id )
review_121 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: seattle_listing5.id )
review_122 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: seattle_listing5.id )
review_123 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: sanfran_listing1.id )
review_124 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: sanfran_listing1.id )
review_125 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: sanfran_listing1.id )
review_126 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: sanfran_listing1.id )
review_127 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: sanfran_listing2.id )
review_128 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: sanfran_listing2.id )
review_129 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: sanfran_listing2.id )
review_130 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: sanfran_listing2.id )
review_131 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: sanfran_listing3.id )
review_132 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: sanfran_listing3.id )
review_133 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: sanfran_listing3.id )
review_134 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: sanfran_listing3.id )
review_135 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: sanfran_listing4.id )
review_136 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: sanfran_listing4.id )
review_137 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: sanfran_listing4.id )
review_138 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: sanfran_listing4.id )
review_139 = Review.create!(body:"Such a beautiful location", guest_id: felix.id, listing_id: sanfran_listing5.id )
review_140 = Review.create!(body:"Such a beautiful location", guest_id: sally.id, listing_id: sanfran_listing5.id )
review_141 = Review.create!(body:"Such a beautiful location", guest_id: demo.id, listing_id: sanfran_listing5.id )
review_142 = Review.create!(body:"Such a beautiful location", guest_id: bob.id, listing_id: sanfran_listing5.id )
